...
console.log("Check equality with string :" , ("Pakistan" as string) != "Peshawer");
console.log("Check equality with string : " , ("Pakistan" as string) == "Peshawer");
...
const books : string[] = ['English', 'Urdu','computer','science'];
...
const books2 : string[] = ['English', 'Urdu','computer','science'];
